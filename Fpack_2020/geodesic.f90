...
!MODIFIED BY DAN FROST 22.6.2016-------
!Prints out two forms of azi1: degrees and radians
!Prints out distance in km (s12km)
!MODIFIED BY DAN FROST 22.6.2016-------
      subroutine invers(a, f, lat1, lon1, lat2, lon2,  &
          s12km, azi1, azir1, omask, a12, m12, MM12, MM21, SS12)
! input
      double precision a, f, lat1, lon1, lat2, lon2
      integer omask
! output
      double precision s12, azi1, azi2, azir1, s12km
! optional output
...
! Convert to radians out of two pi (to match with what george.f produces)
      if (0-(atan2(-salp1, calp1)) .lt. 0) then
      azi1 = 0 - atan2(-salp1, calp1) / degree      
      azir1 = (2*pi - atan2(-salp2, calp2))
      else
      azi1 = 0 - atan2(-salp1, calp1) / degree         
      azir1 = (0 - atan2(-salp2, calp2))
      end if

!      write (*,*) 'deg180',(0-atan2(-salp1, calp1)/degree),'rad180',0-(atan2(-salp1, calp1)),'deg360',azir1
      
 !Convert distance in m to distance in km (to match with what george.f produces)
      s12km=s12/1000
