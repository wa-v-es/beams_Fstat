...
#===================
dist_azi_bazi=(`$py3 $pydir"distcalc_geodesic_STDIN.py" $evla $evlo ${TAlatlon[0]} ${TAlatlon[1]} `)
...
#taup_time -h $evdep -deg $dist_plus -ph P,PP,PPP,PPPP,PPPPP,pP,pPP,pPPP,pPPPP,pPPPPP,Pdiff,SKS,PKS,sSKiKS,sSKIKS,SKIKS,SKiKS,Sdiff,SKKS,SKKKS,SKKKKS,ScS,sScS,S,sS,SS,SSS,SSSS,SSSSS,sSS,sSSS,sSSSS,sSSSSS,sPKS,pPKS,sSKS,sSKKS,sSKKKS,sSKKKKS -mod $model | awk -v dist_plus=$dist_plus '$8==dist_plus' > $temps"PHASE_TIMES_TEMP_$$"
taup_time -h $evdep -deg $dist -ph P,PP,PPP,PPPP,PPPPP,pP,pPP,pPPP,pPPPP,pPPPPP,Pdiff,SKS,PKS,sSKiKS,sSKIKS,SKIKS,SKiKS,Sdiff,SKKS,SKKKS,SKKKKS,ScS,sScS,S,sS,SS,SSS,SSSS,SSSSS,sSS,sSSS,sSSSS,sSSSSS,sPKS,pPKS,sSKS,sSKKS,sSKKKS,sSKKKKS -mod $model > $temps"PHASE_TIMES_TEMP_$$"
cat $temps"PHASE_TIMES_TEMP_$$"
exit
...
${SS[0]} ${SS[1]} 0 ${SS[2]}
${SSS[0]} ${SSS[1]} 0 ${SSS[2]}
${SSSS[0]} ${SSSS[1]} 0 ${SSSS[2]}
${SSSSS[0]} ${SSSSS[1]} 0 ${SSSSS[2]}
${PP[0]} ${PP[1]} 0 ${PP[2]}
${PPP[0]} ${PPP[1]} 0 ${PPP[2]}
${PPPP[0]} ${PPPP[1]} 0 ${PPPP[2]}
${PPPPP[0]} ${PPPPP[1]} 0 ${PPPPP[2]}
${SKIKS[0]} ${SKIKS[1]} 0 ${SKIKS[2]}
${SKScd[0]} ${SKScd[1]} 0 ${SKScd[2]}
${SKS[0]} ${SKS[1]} 0 ${SKS[2]}
${SKKS[0]} ${SKKS[1]} 0 ${SKKS[2]}
${S3KS[0]} ${S3KS[1]} 0 ${S3KS[2]}
${S4KS[0]} ${S4KS[1]} 0 ${S4KS[2]}
${Sdiff[0]} ${Sdiff[1]} 0 ${Sdiff[2]}
${ScS[0]} ${ScS[1]} 0 ${ScS[2]}
...
${lpPPPP[0]} ${lpPPPP[1]} 0 ${lpPPPP[2]}
${lpPPPPP[0]} ${lpPPPPP[1]} 0 ${lpPPPPP[2]}
${lsSS[0]} ${lsSS[1]} 0 ${lsSS[2]}
${lsSSS[0]} ${lsSSS[1]} 0 ${lsSSSS[2]}
${lsSSSS[0]} ${lsSSSS[1]} 0 ${lsSSSS[2]}
${lsSSSSS[0]} ${lsSSSSS[1]} 0 ${lsSSSSS[2]}
${sSKIKS[0]} ${sSKIKS[1]} 0 ${sSKIKS[2]}
${sSKScd[0]} ${sSKScd[1]} 0 ${sSKScd[2]}
${sSKS[0]} ${sSKS[1]} 0 ${sSKS[2]}
${sSKKS[0]} ${sSKKS[1]} 0 ${sSKKS[2]}
${sS3KS[0]} ${sS3KS[1]} 0 ${sS3KS[2]}
${sS4KS[0]} ${sS4KS[1]} 0 ${sS4KS[2]}
${sSdiff[0]} ${sSdiff[1]} 0 ${sSdiff[2]}
${sScS[0]} ${sScS[1]} 0 ${sScS[2]}
${sSwave[0]} ${sSwave[1]} 0 ${sSwave[2]}
${lpPKS[0]} ${lpPKS[1]} 0 ${lpPKS[2]}
${lsPKS[0]} ${lsPKS[1]} 0 ${lsPKS[2]}
EOF
...
if [ $phase == "SKS" ]; then
    ...
    phasePRED=(${S3KS[*]})
elif [ $phase == "S4KS" ]; then
    phasePRED=(${S4KS[*]})
elif [ $phase == "SKScd" ]; then
    phasePRED=(${SKScd[*]})
elif [ $phase == "SKIKS" ]; then
    phasePRED=(${SKIKS[*]})
...
#--------------------
#Set time window
cutmin=`echo ${phasePRED[0]} | awk '{print $1-40}'`
cutmax=`echo ${phasePRED[0]} | awk '{print $1+40}'`
...
itheta=`taup_time -deg $gcarc -mod $model -h $evdep -ph $phase_taup | awk 'NR==6 {print $6}'`
...
for sacfile in `ls *$sackey`; do
    gcarc=`sachead $sacfile gcarc | awk '{print $2}'`
    phtime=`taup_time -deg $gcarc -mod $model -h $evdep -ph $phase_taup | awk 'NR==6 {print $4}'`
...
#Normalisation now handled within F-pack and F-trace, dont normalise input sac traces
#sac<<EOF
#r $sacfile
#write append .norm
#q
...
#PLOT setup
plotcutmin=`echo $cutmin | awk '{print $1+5}'`
plotcutmax=`echo $cutmax | awk '{print $1-5}'`
...
#OUTPUTS
outps=$work"Vespapack_"$outstring"_"$fmin"_"$fmax"Hz_"$delta"samps_"$comp"comp_"$basestation"base_gridnum"$grid_num"_num"$number_used"_"$phase"_"$option_str".ps"
...
awk -v timerange1=$timerange1 '$1<='${beam_max_trc_phase_abs[0]}' && $1>=('${beam_max_trc_phase_abs[0]}'-timerange1*3) {print $1, $2, $3}' filt_dif_max.xy > filt_dif_max_cut.xy
...
beamdif_max_trc_phase_pos=(`awk -v timerange1=$timerange1 '$1>=('${beam_max_trc_phase_abs[0]}'-(timerange1*2)) && $1<='${beam_max_trc_phase_abs[0]}'' filt_dif_max.xy | sort -nrk3,4 | head -n1`)
beamdif_max_trc_phase_neg=(`awk -v timerange1=$timerange1 '$1>=('${beam_max_trc_phase_abs[0]}'-(timerange1*2)) && $1<='${beam_max_trc_phase_abs[0]}'' filt_dif_max.xy | sort -nk3,4 | head -n1`)
...
#DEBUG echo ---
#DEBUG gmt grdinfo $beam_slow_grid
#DEBUG echo ---
#DEBUG gmt grdinfo $xf_slow_grid
#DEBUG echo ---
#DEBUG gmt grdinfo $beam_baz_grid
#DEBUG echo ---
#DEBUG gmt grdinfo $xf_baz_grid


#Update max from grids
xf_grid_max=`awk -v timerange1=$timerange1 -v timerange2=$timerange2 '$1>=('${phasePRED[0]}'-(timerange1*1.5)) && $1<=('${phasePRED[0]}'+(timerange2*1.5)) {print $3}' $xf_slow_xyz | gmt gmtinfo -C | awk '{print $2}'`
...
beam_grid_max=`gmt grdinfo $beam_slow_grid | gawk '/z_max/ {if ((sqrt($3**2))>$5) print (sqrt($3**2)); else print $5}'`
beam_grid_inc=`echo $beam_grid_max | gawk '{print $1/2.5}'`
...
#Create CPTS
gmt makecpt -Chot -T0/$xf_grid_max/$xf_grid_inc -I -Z > $temps"TEMP_XF.cpt_$$"
...
symb_direct="-Sc0.2c -Gpurple -W0.04c"
symb_depth="-Sc0.2c -Gdarkgreen -W0.04c"
text_direct=" -F+jCM+a90,+f14,0,purple"
text_depth=" -F+jCM+a90,+f14,0,darkgreen"


#Symbols for picked phases
symb_beam_wholemax="-Sa0.4c -Gwhite -W0.04c"
symb_beam_phasemax="-Sa0.4c -Gblue -W0.04c"
symb_xf_phasemax="-Sa0.4c -Ggreen -W0.04c"
symb_onset="-Sa0.4c -Gred -W0.04c"
...
gmt pstext -F+jLM+a0+f12,0,black $frame $range_text -N -O -K <<EOF >> $outps
-0.35 12.25 Max whole window
-0.35 11.75 Beam max
-0.35 11.25 XF max
-0.35 10.75 Beam onset
EOF
#-------------------------------------------------
#XF SLOW - END (3) ----------
#-------------------------------------------------
...
gmt pstext $frame_text $range_text -F+jLM+a0+f12,0,black -O -N -Y-$yoffset2 -X-$xoffset1 -K <<EOF >> $outps
...
3.5 7 TrcesSNR mn,SD,minmax: ${snr_mean_std[0]} ${snr_mean_std[1]} ${snr_min_max[0]} ${snr_min_max[1]}
EOF
gmt pstext $frame_text $range_text -F+jRT+a0+f12,1,black -O -N -K <<EOF >> $outps
...
#Amplitude
gmt pstext $frame_text $range_text -O -F+jLM+a0+f14,1,purple -N -K <<EOF >> $outps
-0.5 -1.5 Amp: $ampav PN:${amp_posneg[0]}
EOF
...
map_frame="-JR4.0c"
gmt pscoast $map_range $map_frame -B1WSen -W0.05c,darkgreen -Dl -N1/0.03c,lightgreen -Ggray -N2/0.03c,lightgreen -A5000 -Y$yoffset_map -O -K >> $outps
awk '{print $2, $3}' station_list_TOTAL | gmt psxy $map_range $map_frame -Si0.4c -W0.04c -: -O -K >> $outps
awk '{print $7, $8, $3}' STA_DISTANCE_LOC.txt | gmt psxy $map_range $map_frame -Si0.4c -Gred -W0.04c -N -: -O -K >> $outps
awk '{print $7, $8, $3}' STA_DISTANCE_LOC.txt | gmt pstext -F+jCM+a0+f10,0,blue $map_range $map_frame -: -O -K -N >> $outps
echo ${TAlatlon[0]} ${TAlatlon[1]} | gmt psxy $map_range $map_frame -Si0.4c -Gyellow -W0.04c -: -O -K >> $outps
echo $grid_lon $grid_lat | gmt psxy $map_range $map_frame -Sc0.3c -Gpurple -W0.04c -O -K >> $outps
...
gmt psbasemap $sac_range $sac_frame -B10g10:"Time after origin (s)":/1:"Distance (deg)":WSen -O -K -X7c >> $outps
...
echo -e ${beamdif_onset_trc_phase[0]} ${dist_minmax[0]}"\n"${beamdif_onset_trc_phase[0]} ${dist_minmax[1]} | gmt psxy $sac_range $sac_frame -W0.05c,red -O -K >> $outps
echo -e ${phasePRED[0]} ${dist_minmax[0]}"\n"${phasePRED[0]} ${dist_minmax[1]} | gmt psxy $sac_range $sac_frame -W0.05c,purple,"-" -O -K >> $outps
else
echo -e $moveout_min ${dist_minmax[0]}"\n"$moveout_max ${dist_minmax[1]} | gmt psxy $sac_range $sac_frame -W0.05c,red -O -K >> $outps
echo -e $moveout_min_PRED ${dist_minmax[0]}"\n"$moveout_max_PRED ${dist_minmax[1]} | gmt psxy $sac_range $sac_frame -W0.05c,purple,"-" -O -K >> $outps
fi
awk -v dist=$dist 'NR==3 {print $1, dist}' $temps"SmKS_picks_"$proc_id | gmt psxy $sac_range $sac_frame -Sy3.0c -W0.04c,green -O -K >> $outps
#Plot moveout of picked phase (time and slow) and predicted phase
#-----
...
awk -v shift=$shift '{print ($1)-shift, '$distance', $2/('$trcmax')}' sac.xy | gmt pswiggle $sac_range $sac_frame -Z$sac_scale_y -W0.025c -O -K >> $outps
else
    awk '{print $1, '$distance', $2/('$trcmax')}' sac.xy | gmt pswiggle $sac_range $sac_frame -Z$sac_scale_y -W0.025c -O -K >> $outps
fi
echo $xpos $distance $stanm | gmt pstext -F+jLM+a0+f12,0,black $sac_range_text $sac_frame -N -O -K >> $outps
...
awk -v tmin=${filttime_minmax[0]} -v tmax=${filttime_minmax[1]} '$1>(tmin+10) && $1<(tmax-10) {print $1, '$dist', ($3/'$vmax')}' filt_max.xy | gmt pswiggle $sac_range $sac_frame -Z$sac_scale_y_dbl -W0.075c,blue -O -K >> $outps
echo 10.25 $dist BEAM | gmt pstext -F+jLM+a0+f12,1,blue $sac_range_text $sac_frame -N -O -K >> $outps
...
awk -v tmin=${filttime_minmax[0]} -v tmax=${filttime_minmax[1]} '$1>(tmin+10) && $1<(tmax-10) {print $1, '$dist'+0.25, ($3/'$vmax')}' xf_max.xy | gmt pswiggle $sac_range $sac_frame -Z$sac_scale_y_dbl -W0.075c,darkgreen -O -K >> $outps
echo 10.25 $dist FTRACE | awk '{print $1, $2+0.5, $3}' | gmt pstext $sac_range_text $sac_frame -F+jLM+a0+f12,1,darkgreen -N -O -K >> $outps
...
awk -v tmin=${filttime_minmax[0]} -v tmax=${filttime_minmax[1]} '$1>(tmin+10) && $1<(tmax-10) {print $1, '$dist'-0.25, ($3/'$vmax')}' filt_dif_max.xy | gmt pswiggle $sac_range $sac_frame -Z$sac_scale_y_dbl -W0.075c,purple -O -K >> $outps
echo 10.25 $dist BEAMDIF | awk '{print $1, $2-0.5, $3}' | gmt pstext $sac_range_text $sac_frame -F+jLM+a0+f12,1,purple -N -O -K >> $outps
...
SmKS_Record_Plot_2020.bsh $plotcutmin $plotcutmax $numtraces $sackey ${beamdif_onset_trc_phase[0]} ${beamdif_onset_trc_phase[1]} $phase ${phasePRED[0]} ${phasePRED[1]} $dist $outps $grid_num $basestation $proc_id $amplow $xf_grid_max $grid_lat $grid_lon
echo SmKS_Record_Plot_2020.bsh $plotcutmin $plotcutmax $numtraces $sc ${beamdif_onset_trc_phase[0]} ${beamdif_onset_trc_phase[1]} $phase ${phasePRED[0]} ${phasePRED[1]} $dist $outps $grid_num $basestation $proc_id $amplow $grid_lat $grid_lon
...
#filt_dif_max.xy filt_max.xy filt.xy filt_dif.xy filt_dif_max_cut.xy
